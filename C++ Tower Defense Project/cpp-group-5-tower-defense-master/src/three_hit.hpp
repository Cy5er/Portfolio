...
class three_hit : public base_monster {
    
    public:
        three_hit(std::string name, size_t hp);
        three_hit(std::string name, size_t hp, sf::Vector2f position); // constructor with a specific position
        ~three_hit();
