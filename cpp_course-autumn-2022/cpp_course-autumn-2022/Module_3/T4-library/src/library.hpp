...
public:
    ...
    */
        ...
        Library(std::string const& lib_name);
    ...
    */
        ...
        std::vector<Book> FindBooksByAuthor(std::string const& author);
    ...
    */
        ...
        Customer FindCustomer(std::string const& c_id);
...
private:
   ...
   std::vector<Book> name_;
   std::vector<Customer> c_id_;
};
